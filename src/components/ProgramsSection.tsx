export default function Programs() {
  ...
  return (
    <section
      id='programs'
      className='w-full bg-[#1a2e1a] py-24 px-6 text-stone-100'
    >
      <div className='max-w-6xl mx-auto'>
        <div className='mb-16'>
          <h2 className='text-emerald-400 text-sm font-bold uppercase tracking-widest mb-2'>
            Our Offerings
          </h2>
        ...
        <div className='grid grid-cols-1 md:grid-cols-3 gap-8'>
          {classes.map((course, index) => (
            <div
              key={index}
              className='group relative bg-stone-900/40 border border-white/10 p-8 rounded-3xl hover:bg-stone-800/60 transition-all duration-500'
            >
              ...
              <div className='flex justify-between items-start mb-6'>
                <div>
                  <span className='text-emerald-400 text-xs uppercase font-bold tracking-tighter'>
                    {course.level}
                  </span>
